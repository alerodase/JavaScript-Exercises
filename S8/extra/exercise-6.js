...
// deberíamos hacer es una petición a personajes para imprimir sus datos en la página web. Tanto nombre, como imágenes y estadísticas.
let resData;
...
async function drawCharacter() {
    const characterCard = document.querySelector(`div[data-function="characters"]`);
    for (let i = 0; i < resData.length; i++) {
        ...
        characterCard.appendChild(stats);
